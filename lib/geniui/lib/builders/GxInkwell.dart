...
///
/// [target] Provides the target directory for the `GxInkWell` class
const String target = "geniui/lib/widgets/";

/// Get the full file path for the `GxInkWell` Class
///
/// [file] This gives a boilerplate for the `GxInkWell` class
const String file = "geniui/lib/widgets/GxInkwell.dart";

/// Get the stub content for the `GxInkWell` Class
///
/// [stub] This gives a boilerplate for the `GxInkWell` class
const String stub = """
...
class GxInkWell extends GxWidgetBuilder<Widget> with GxGestureMixin<GxInkWell> {
  ...
  GxInkWell enableFeedback(bool enableFeedback) => this.._enableFeedback = enableFeedback;
  GxInkWell excludeFromSemantics(bool excludeFromSemantics) => this.._excludeFromSemantics = excludeFromSemantics;
  GxInkWell canRequestFocus(bool canRequestFocus) => this.._canRequestFocus = canRequestFocus;
  ...
  GxInkWell highlightColor(Color highlightColor) => this.._highlightColor = highlightColor;
  GxInkWell overlayColor(MaterialStateProperty<Color?> overlayColor) => this.._overlayColor = overlayColor;
  GxInkWell splashColor(Color splashColor) => this.._splashColor = splashColor;

  /// Handle Misc Options
  GxInkWell borderRadius(BorderRadius borderRadius) => this.._borderRadius = borderRadius;
  GxInkWell mouseCursor(MouseCursor mouseCursor) => this.._mouseCursor = mouseCursor;
  GxInkWell customBorder(ShapeBorder customBorder) => this.._customBorder = customBorder;
