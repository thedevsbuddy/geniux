...
class GxStack extends GxWidgetBuilder<Widget> {
  ...
  GxStack get clipAntiAliasWithSaveLayer =>
...
extension StackExtensions on Stack {
  GxStack get isStack =>
      GxStack.existing(children, alignment, clipBehavior, textDirection!, fit);
}
