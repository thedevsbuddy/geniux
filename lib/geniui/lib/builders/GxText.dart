...
///
/// [target] Provides the target directory for the `GxText` class
const String target = "geniui/lib/widgets/";

/// Get the full file path for the `GxText` Class
///
/// [file] gives a filename for the `GxText` class
const String file = "geniui/lib/widgets/GxText.dart";

/// Get the stub content for the `GxText` Class
///
/// [stub] This gives a boilerplate for the `GxText` class
const String stub = """
...
class GxText extends GxWidgetBuilder<Widget> with GxColorMixin<GxText> {
  ...
  GxText get hairLine => _fontWeightedText(child: this, weight: FontWeight.w100);
  ...
  GxText get semiBold => _fontWeightedText(child: this, weight: FontWeight.w600);
  ...
  GxText get extraBold => _fontWeightedText(child: this, weight: FontWeight.w800);

  /// Sets [FontWeight] to [FontWeight.w900]
  GxText get extraBlack => _fontWeightedText(child: this, weight: FontWeight.w900);

  GxText _fontWeightedText({required FontWeight weight, required GxText child}) {
    _fontWeight = weight;
    return this;
  }
