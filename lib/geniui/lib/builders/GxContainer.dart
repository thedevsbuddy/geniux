...
///
/// [target] Provides the target directory for the `GxContainer` class
const String target = "geniui/lib/widgets/";

/// Get the full file path for the `GxContainer` Class
///
/// [file] This gives a boilerplate for the `GxContainer` class
const String file = "geniui/lib/widgets/GxContainer.dart";

/// Get the stub content for the `GxContainer` Class
///
/// [stub] This gives a boilerplate for the `GxContainer` class
const String stub = """
...
class GxContainer extends GxWidgetBuilder<Widget>
  ...
  GxContainer withDecoration(BoxDecoration decoration) => this.._decoration = decoration;

  /// Provide a custom Foreground DecoratedBox
  GxContainer withForegroundDecoration(BoxDecoration decoration) => this.._foregroundDecoration = decoration;

  /// Provide a box constraint
  GxContainer withConstraints(BoxConstraints constraints) => this.._constraints = constraints;
  ...
  GxContainer hexColor(String colorHex) => this..gxColor = Color(int.parse(GxUtils.hexToColor(colorHex)));
  ...
  GxContainer get clipAliasWithSaveLayer => this.._clip = Clip.antiAliasWithSaveLayer;
  ...
  GxContainer linearGradient(LinearGradient linearGradient) => this.._gradient = linearGradient;

  /// Sets the radial gradient to the decorated box.
  GxContainer radialGradient(RadialGradient radialGradient) => this.._gradient = radialGradient;

  /// Sets the sweep gradient to the decorated box.
  GxContainer sweepGradient(SweepGradient sweepGradient) => this.._gradient = sweepGradient;
