...
///
/// [target] Provides the target directory for the `GxRoundnessMixin` class
const String target = "geniui/lib/mixins/";

/// Get the full file path for the `GxRoundnessMixin` Class
///
/// [file] This gives a boilerplate for the `GxRoundnessMixin` class
const String file = "geniui/lib/mixins/GxRoundnessMixin.dart";

/// Get the stub content for the `GxRoundnessMixin` Class
///
/// [stub] This gives a boilerplate for the `GxRoundnessMixin` class
const String stub = """
import 'package:flutter/material.dart';

mixin GxRoundnessMixin<T> {
  late T _child;
