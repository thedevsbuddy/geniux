...
///
/// [target] Provides the target directory for the `GxButton` class
const String target = "geniui/lib/widgets/";

/// Get the full file path for the `GxButton` Class
///
/// [file] This gives a boilerplate for the `GxButton` class
const String file = "geniui/lib/widgets/GxButton.dart";

/// Get the stub content for the `GxButton` Class
///
/// [stub] This gives a boilerplate for the `GxButton` class
const String stub = """
...
class GxButton extends GxWidgetBuilder<Widget>
  ...
  GxButton withConstraints(BoxConstraints constraints) => this.._constraints = constraints;
  ...
  GxButton linearGradient(LinearGradient linearGradient) => this.._gradient = linearGradient;

  /// Sets the radial gradient to the decorated box.
  GxButton radialGradient(RadialGradient radialGradient) => this.._gradient = radialGradient;

  /// Sets the sweep gradient to the decorated box.
  GxButton sweepGradient(SweepGradient sweepGradient) => this.._gradient = sweepGradient;
