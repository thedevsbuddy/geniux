...
///
/// [target] Provides the target directory for the `GxSizeMixin` class
const String target = "geniui/lib/mixins/";

/// Get the full file path for the `GxSizeMixin` Class
///
/// [file] This gives a boilerplate for the `GxSizeMixin` class
const String file = "geniui/lib/mixins/GxSizeMixin.dart";

/// Get the stub content for the `GxSizeMixin` Class
///
/// [stub] This gives a boilerplate for the `GxSizeMixin` class
const String stub = """
