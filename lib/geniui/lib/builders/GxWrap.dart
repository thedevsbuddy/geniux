...
///
/// [target] Provides the target directory for the `GxWrap` class
const String target = "geniui/lib/widgets/";

/// Get the full file path for the `GxWrap` Class
///
/// [file] This gives a boilerplate for the `GxWrap` class
const String file = "geniui/lib/widgets/GxWrap.dart";

/// Get the stub content for the `GxWrap` Class
///
/// [stub] This gives a boilerplate for the `GxWrap` class
const String stub = """
...
class GxWrap extends GxWidgetBuilder<Widget> {
  ...
  GxWrap get alignCenter => this.._crossAxisAlignment = WrapCrossAlignment.center;
  ...
  GxWrap get clipAntiAliasWithSaveLayer => this.._clipBehavior = Clip.antiAliasWithSaveLayer;
...
extension WrapExtensions on Wrap {
  GxWrap get isWrap => GxWrap.existing(children, direction, alignment, crossAxisAlignment, clipBehavior);
}
